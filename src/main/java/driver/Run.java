...
public class Run {
    private static String logDirectoryName = "results";
    ...
    private static void installShutdownHook() {
        Runtime.getRuntime().addShutdownHook(new Thread(() -> {
            ...
            List<String> allCurrentPassedTests = new ArrayList<String>(
                    Arrays.asList(Constants.SUCCESS_TESTS_SB.toString().split("\n"))
            );
            ...
            List<String> allCurrentCrashedTests = new ArrayList<String>(
                    Arrays.asList(Constants.CRASHED_TESTS_SB.toString().split("\n"))
            );
            ...
            Log(
                "UnsupportedErrorCodes.txt",
                "List of all test cases:\n",
                Constants.UNSUPPORTED_ERRORS_SB
            );
            Log("Skipped.txt", "List of all test cases:\n", Constants.SKIPPED_TESTS_SB);
            ...
            Log(
                "BrokenWithLatestImplementation.txt",
