...
An Expression can be: \todo{@ Ghislain Fourny: Check if  this is the correct List. Check if it  matches Table 2.1 for categorizing the runtime iterators}
\begin{itemize}
	\item Arithmetic
	\item Logic
	\item Comparison
...
\todo{@Ghislain Fourny: In theory I could also delete the whole Mapping, I do explain it briefly afterwards in iterators and how SQL is used}
...
\todo{@Ghislain Fourny: Check if table makes sense for the plus signs. In paper it was written which mode sequence-transforming, producing and combining use and I wanted to copy that. But from our last conversation I think this is the current state. Do I need to explain in words which primitives are used (RDD union, flatmap etc...) or is this enough?}
